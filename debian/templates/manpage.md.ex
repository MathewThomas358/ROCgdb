...
rocgdb - program to do something

# SYNOPSIS

**rocgdb** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**rocgdb** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **rocgdb** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**rocgdb** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    rocgdb. See **foo.conf**(5) for further details.
...
**rocgdb** provides some return codes, that can be used in scripts:
...
Mathew Thomas <mathewthomas358@gmail.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Mathew Thomas
